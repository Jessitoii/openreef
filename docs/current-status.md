...
| Trigger/automation runtime | Trigger infra implies proactive task execution | Trigger channel/event plumbing exists, but `TriggerSystem` is not bootstrapped and trigger events are not mapped into agent tasks | NON_FUNCTIONAL |
